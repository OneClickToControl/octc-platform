...
Pasos completos: [docs/runbooks/NEW_PRODUCT_REPO.md](../../docs/runbooks/NEW_PRODUCT_REPO.md).
...
Runbook: [docs/runbooks/PORTFOLIO_DISPATCH_SETUP.md](../../docs/runbooks/PORTFOLIO_DISPATCH_SETUP.md) (deploy del callable debe estar en `main` de `octc-platform` antes de que los dispatch en producto pasen).
...
- **`octc portfolio suggest`** — lee `.octc/monorepo.yaml` y emite fragmentos para PORTFOLIO interno. Flags: `--cwd`, `--repo`, `--cli-pin`; env `OCTC_PORTFOLIO_*`. Documentación: [PORTFOLIO_BRIDGE](https://github.com/OneClickToControl/octc-platform/blob/main/docs/adoption/PORTFOLIO_BRIDGE.md).

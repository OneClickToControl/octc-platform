...
| H-Q2-002 | media | Aún no hay paquetes `@1c2c/*` extraídos. | Iniciar `@1c2c/eslint-config` y `@1c2c/tsconfig` desde `health-app`. | @1click2control | 2026-05-15 | **cerrado** 2026-04-29 (PR `feat/packages-bootstrap-tsconfig-eslint`) |
...
| H-Q2-004 | alta | SSO + 2FA enforcement por confirmar en GitHub/Vercel/Supabase/Sentry. | Auditar y forzar. | @1click2control | 2026-05-10 | abierto (token CI sin `admin:org`; aplicar manual) |
| H-Q2-005 | media | `tools_allowlist_ref` aún no definido para health-acp. | Documentar lista L2 en `health-app-agents`. | @1click2control | 2026-06-01 | abierto |
...
| H-Q2-008 | baja | Plantillas Sentry sin probar en stack real. | Smoke test en `health-app` y `store-app`. | @1click2control | 2026-05-30 | abierto |

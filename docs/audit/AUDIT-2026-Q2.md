...
| H-Q2-002 | media | Aún no hay paquetes `@1c2c/*` extraídos. | Iniciar `@1c2c/eslint-config` y `@1c2c/tsconfig` desde `product`. | @ferflechas | 2026-05-15 |
...
| H-Q2-005 | media | `tools_allowlist_ref` aún no definido para health-acp. | Documentar lista L2 en `product-acp`. | @ferflechas | 2026-06-01 |
...
| H-Q2-008 | baja | Plantillas Sentry sin probar en stack real. | Smoke test en `product` y `product-b`. | @ferflechas | 2026-05-30 |

...
Los nombres `product`, `product-acp`, `product-b`, `product-c`, `workspace-runtime`, `legacy-copilot`, `1click2control` son repos privados y **no deben aparecer en este repo público** salvo:

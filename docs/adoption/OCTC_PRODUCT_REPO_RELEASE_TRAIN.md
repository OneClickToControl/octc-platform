...
Este repo público publica los paquetes `@1c2c/*` vía [`.github/workflows/release.yml`](../../.github/workflows/release.yml) (Changesets + npm). Tras cada publicación, los productos hoy actualizan versiones mediante **Dependabot** y checklist manual ([merge train](https://github.com/OneClickToControl/octc-platform-internal/blob/main/docs/runbooks/OCTC_MERGE_TRAIN_CHECKLIST.md)).

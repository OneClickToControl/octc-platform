...
`octc-platform` **no** contiene código de producto: solo normas, paquetes compartidos y plantillas. Los productos viven en sus propios repos (`health-app`, `store-app`, `strategy-app`, `1click2control`, …) y consumen la plataforma por versión.

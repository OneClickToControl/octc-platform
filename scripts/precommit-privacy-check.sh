...
PATTERNS=(
  ...
  "octc-private-repo-name|Reference to a private OneClickToControl repository|\\b(health-app(-agents)?|store-app|strategy-app|openclaw-workspace-enlaza|ats-copilot-agent)\\b"

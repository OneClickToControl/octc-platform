...
ALLOWLIST_REGEX='^(\.gitleaks\.toml|\.github/workflows/privacy-guard\.yml|scripts/precommit-privacy-check\.sh|docs/PORTFOLIO\.md|docs/observability/SENTRY_PROJECTS\.md|docs/audit/.*\.md|pnpm-lock\.yaml|templates/governance/privacy-guard/.*)$'
